...
<div id="main" class="clearfix main" role="main">
  <div class="container">
    ...
    <div id="main-content" class="row main-content">
      ...
      <!-- /#sidebar-first -->
      <?php endif; ?>
      <div id="content" class="mc-content <?php if (($page['sidebar_first']) && ($page['sidebar_second'])): print 'col-md-6'; elseif (($page['sidebar_first']) || ($page['sidebar_second'])): print 'col-md-9'; else: print 'col-md-12'; endif; ?>">
        <div id="content-wrapper" class="content-wrapper">
          ...
          <div id="content-col2" class="row content-col2">
            ...
            <div class="col-md-6">
              <div id="content-col2-1" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col2-1']); ?> </div>
            </div>
            <?php endif; ?>
            <?php if ($page['content_col2-2']): ?>
            <div class="col-md-6">
              <div id="content-col2-2" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col2-2']); ?> </div>
            </div>
            <?php endif; ?>
          </div>
          <?php endif; ?>
          ...
          <div id="content-col3" class="row content-col3">
            ...
            <div class="col-md-4">
              <div id="content-col3-1" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col3-1']); ?> </div>
            </div>
            <?php endif; ?>
            <?php if ($page['content_col3-2']): ?>
            <div class="col-md-4">
              <div id="content-col3-2" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col3-2']); ?> </div>
            </div>
            <?php endif; ?>
            <?php if ($page['content_col3-3']): ?>
            <div class="col-md-4">
              <div id="content-col3-3" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col3-3']); ?> </div>
            </div>
            <?php endif; ?>
          </div>
          <?php endif; ?>
          ...
          <div id="content-col4" class="row content-col4">
            ...
            <div class="col-md-3">
              <div id="content-col4-1" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col4-1']); ?> </div>
            </div>
            <?php endif; ?>
            <?php if ($page['content_col4-2']): ?>
            <div class="col-md-3">
              <div id="content-col4-2" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col4-2']); ?> </div>
            </div>
            <?php endif; ?>
            <?php if ($page['content_col4-3']): ?>
            <div class="col-md-3">
              <div id="content-col4-3" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col4-3']); ?> </div>
            </div>
            <?php endif; ?>
            <?php if ($page['content_col4-4']): ?>
            <div class="col-md-3">
              <div id="content-col4-4" class="col-md-12 clearfix clear-row"> <?php print render($page['content_col4-4']); ?> </div>
            </div>
            <?php endif; ?>
          </div>
          <?php endif; ?>
